...
resource "oci_core_instance" "dns_forward_instance_01" {
  availability_domain = data.oci_identity_availability_domains.pdns_ads.availability_domains[0]["name"]
  compartment_id      = var.oci_compartment_ocid
...
resource "oci_core_instance" "dns_forward_instance_02" {
  availability_domain = data.oci_identity_availability_domains.pdns_ads.availability_domains[1]["name"]
  compartment_id      = var.oci_compartment_ocid
  shape               = "VM.Standard2.1"
